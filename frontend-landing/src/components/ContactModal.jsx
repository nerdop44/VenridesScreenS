...
const ContactModal = ({ isOpen, onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await FormService.submitContact(formData);
            ...
            <div className="glass max-w-2xl w-full mx-4 p-8 rounded-3xl border border-white/20 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p className="text-slate-400 text-sm mt-2">Estamos aquí para ayudarte</p>
                    </div>
                    <button
                        onClick={onClose}
                ...
                {submitStatus === 'success' && (
                    <div className="mb-6 p-4 bg-primary/20 border border-primary rounded-xl flex items-center gap-3">
                        ...
                        <p className="text-primary font-bold">¡Mensaje enviado! Te responderemos a la brevedad.</p>
                    </div>
                )}
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Demostración">Solicitar Demostración</option>
